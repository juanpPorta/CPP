...
/*   Updated: 2022/07/05 18:39:05 by jporta           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(std::string name) :  name(name), _hitpoints(10), _energyPoints(10), _atackDamage(3)
{
	std::cout<<"Constructor ClapTrap_name called"<<std::endl;
}
...
{
	std::cout<<"ClapTrap " << this->name << " attack " << 	target << ", causing " << this->_atackDamage << " points of damage! "<<std::endl;
}
...
{
	std::cout<<"ClapTrap "<<this->name << " takes "<< amount << " points yea Be Repaired!"<<std::endl;
}
